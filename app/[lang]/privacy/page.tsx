...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return buildMetadata({
    lang,
    path: "/privacy",
    title: lang === "zh" ? "隐私说明 | 镜桥创意" : "Privacy Notice | FrameBridge Studio",
    description:
      lang === "zh"
        ? "了解项目咨询信息的收集与使用方式。"
  ...
  return (
    <section className="bg-pearl pt-36">
      <article className="container-x max-w-4xl pb-28">
        ...
        {(zh
          ? [
              "我们可能收集姓名、公司、工作邮箱、联系方式、项目范围、预算、日期、地点及您主动提供的其他信息。",
              "这些信息用于回复询盘、评估项目、准备方案、协调资源并防止表单滥用。配置在线提交后，信息可能传至公司指定的工作流供应商。",
              "我们不会通过分析属性传递个人信息。请勿在初次咨询中提交不必要的敏感或机密材料。",
              "如需了解或更正已提交的项目信息，请通过网站公布的联系邮箱与我们沟通。"
            ]
          : [
              "We may collect your name, organisation, work email, contact details, project scope, budget, dates, location and other information you choose to provide.",
              "This information is used to respond to enquiries, assess projects, prepare proposals, coordinate resources and prevent form abuse. When online delivery is configured, information may be sent to the company’s designated workflow provider.",
