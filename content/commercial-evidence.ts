...
export const universityTalentCases: CommercialEvidenceCase[] = [
  {
    ...
    context: localised("Brand-supported cultural engagement in a Cambridge-based community setting.", "在剑桥本地社群场景中开展品牌支持的文化互动。"),
    programme: localised("A culturally relevant community programme shaped around participation rather than event exposure alone.", "围绕真实参与而非单纯活动曝光设计的文化社群项目。"),
    venusBridgeRole: localised("Programme context, participant coordination and local delivery, subject to final evidence confirmation.", "项目语境、参与方协调与本地落地；最终公开表述以证据核验为准。"),
    evidence: localised("Programme records are held for naming, relationship and publication review.", "项目记录正在进行名称、关系层级与公开授权审核。"),
  ...
  },
  {
    ...
    context: localised("A university-facing employer visibility and graduate engagement context.", "面向高校场景的雇主品牌与毕业生沟通语境。"),
    programme: localised("Employer presentation, audience engagement and locally coordinated programme delivery.", "雇主展示、受众互动与本地项目协调交付。"),
    venusBridgeRole: localised("Programme design, bilingual coordination and local delivery—not recruitment representation.", "项目设计、双语协调与本地落地，不承担招聘代理角色。"),
    evidence: localised("Employer, institution, date and outcome details remain withheld until publication checks are complete.", "雇主、机构、日期与成果信息将在公开审核完成后补充。"),
  ...
  },
  {
    ...
    context: localised("Brand and community engagement connected with a London university-community setting.", "与伦敦高校社群场景相关的品牌与社区互动。"),
    programme: localised("A community-facing activation built around cultural relevance, participation and responsible local coordination.", "围绕文化相关性、社群参与与可靠本地协调形成的项目。"),
    venusBridgeRole: localised("Context definition, stakeholder coordination and accountable local delivery, subject to final evidence confirmation.", "场景定义、参与方协调与可追责的本地交付；最终公开表述以证据核验为准。"),
    evidence: localised("Exact organisation, sponsor and relationship wording will be added only after verification and permission.", "具体机构、赞助方与关系表述仅在核实并获许可后补充。"),
    capabilities: ["institutional-engagement", "cultural-engagement", "stakeholder-engagement"],
    audience: localised("University-community and culturally relevant local audiences", "高校社群与具有文化相关性的当地受众"),
    institutionalRelationshipLevel: "unverified",
    media: [],
    mediaStatus: "pending",
    evidenceStatus: "context-confirmed"
