...
export function ProcessTimeline({ steps, dark = false }: { steps: string[]; dark?: boolean }) {
        ...
        return (
          <motion.article
            ...
            className={cn(
              ...
              dark
                ? "border-pearl/10 bg-pearl/[0.04] text-pearl"
          ...
          >
            <span className={cn("text-sm font-semibold", dark ? "text-champagne" : "text-slate")}>
              0{index + 1}
            </span>
